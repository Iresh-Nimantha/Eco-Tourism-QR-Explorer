          ...
          <div className="lg:pr-4">
            <div className="relative mx-auto max-w-xl text-center lg:mx-0 lg:text-left">
              ...
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Chartered in 2017, the Leo Club of the University of Colombo,
                Faculty of Arts, is a youth-led initiative dedicated to
                community enhancement and leadership development.
              </p>
              <p className="mt-6 text-lg leading-8 text-gray-600">
                Our mission is to create a more enriched society through
                sustainable, impactful projects. We tackle key challenges across
                healthcare, education, environmental stewardship, and social
                empowerment, turning passion into positive action. We are proud
                to nurture the spirit of responsible citizenship and empower the
