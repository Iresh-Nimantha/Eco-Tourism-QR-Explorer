...
const HowItWorksSection = () => {
  return (
    // FIX: Standardized vertical padding for consistency
    <section
      id="how-it-works"
    ...
    >
      <div className="w-full max-w-6xl">
        {/* FIX: Centered text block with consistent styles */}
        ...
        {/* FIX: Increased margin-top to give title space */}
        <div className="mt-20 flex flex-col items-center justify-center gap-10 md:flex-row md:gap-8 xl:gap-12">
          ...
          <div className="flex max-w-xs flex-1 flex-col items-center min-w-[230px]">
            <div className="mb-5 aspect-square w-full overflow-hidden rounded-xl shadow-md">
              <img
                src="/how-1.png"
                alt="Spot the Code"
